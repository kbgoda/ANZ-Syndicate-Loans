...
/*
Contract for ANZ Digital Disruption Blockchain Project
Author: Karan Goda
*/
...
*/
    ...
    */
    ...
    // A person can only see their own loans' names by entering loan id
    function seeLoan (uint loanNum) view public returns (uint id, string memory name, string memory purpose) {
        require(loanNum >= 0 && loanNum < loanId);
        return (loans[loanNum].id, loans[loanNum].name, loans[loanNum].dataString);
    }
